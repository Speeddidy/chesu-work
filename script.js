...
const availableSkills = [
  "Python", "Django", "PostgreSQL", "Git", "React", "TypeScript", "HTML", "CSS", "JavaScript",
  "Adobe Photoshop", "Illustrator", "1С", "Digital-маркетинг", "Google Analytics", "SEO", "Копирайтинг",
  "Продажи", "Коммуникация", "Переговоры", "Флористика", "Креативность", "Обслуживание клиентов",
  "Linux", "Windows", "Сетевые протоколы", "Безопасность", "Рекрутинг", "Трудовое законодательство",
  "Водительские навыки", "Клиентоориентированность", "Кулинария", "Санитарные нормы", "Командная работа"
];
...
let jobs = [
  { 
    ...
    lng: 45.6949, 
    description: "ул. Мира", 
    fullDescription: "Разработка серверной части приложений на Python, работа с Django и PostgreSQL.", 
    city: "Грозный", 
    salaryMin: 150000, 
    salaryMax: 200000, 
    experience: "3-6", 
    ...
    internship: "no", 
    workFormat: "office",
    conditions: ["- Полный социальный пакет", "- Корпоративное обучение", "- Гибкое начало рабочего дня"],
    responsibilities: ["- Разработка и поддержка серверной части приложений", "- Оптимизация производительности кода", "- Интеграция с внешними API"],
    requirements: ["- Опыт работы с Python от 3 лет", "- Знание Django и PostgreSQL", "- Умение работать в команде"],
  ...
  { 
    ...
    fullDescription: "Работа с клиентами, обзвон, обработка заказов, подготовка документов.", 
    city: "Грозный", 
    salaryMin: 70000, 
    salaryMax: null, 
    experience: "1-3", 
    ...
    internship: "no", 
    workFormat: "office",
    conditions: ["- Официальное оформление", "- Бонусы за выполнение плана", "- Корпоративный транспорт"],
    responsibilities: ["- Поиск и привлечение клиентов", "- Ведение переговоров", "- Подготовка коммерческих предложений"],
    requirements: ["- Опыт продаж от 1 года", "- Знание ПК и MS Office", "- Коммуникабельность"],
  ...
  { 
    ...
    fullDescription: "Сборка цветочных композиций, работа с клиентами, обучение стилю компании.", 
    city: "Грозный", 
    salaryMin: 50000, 
    salaryMax: 80000, 
    ...
    internship: "yes", 
    workFormat: "office",
    conditions: ["- Гибкий график", "- Скидки на продукцию", "- Обучение за счет компании"],
    responsibilities: ["- Создание букетов и композиций", "- Консультация клиентов", "- Уход за цветами"],
    requirements: ["- Базовые навыки флористики или желание обучаться", "- Креативность", "- Доброжелательность"],
  ...
  { 
    ...
    fullDescription: "Разработка интерфейсов с использованием React и TypeScript.", 
    city: "Грозный", 
    salaryMin: 120000, 
    salaryMax: 150000, 
    experience: "1-3", 
    ...
    internship: "no", 
    workFormat: "remote",
    conditions: ["- Удаленная работа", "- Техническое обеспечение", "- Гибкий график"],
    responsibilities: ["- Разработка пользовательских интерфейсов", "- Оптимизация фронтенд-кода", "- Взаимодействие с дизайнерами"],
    requirements: ["- Опыт с React и TypeScript от 1 года", "- Знание HTML и CSS", "- Понимание REST API"],
  ...
  { 
    ...
    fullDescription: "Создание визуального контента, брендинга и рекламных материалов.", 
    city: "Грозный", 
    salaryMin: 80000, 
    salaryMax: null, 
    experience: "1-3", 
    ...
    internship: "no", 
    workFormat: "hybrid",
    conditions: ["- Гибридный формат работы", "- Корпоративные скидки", "- Творческая свобода"],
    responsibilities: ["- Разработка дизайна для рекламы", "- Создание брендинга", "- Подготовка макетов"],
    requirements: ["- Опыт работы от 1 года", "- Владение Adobe Photoshop и Illustrator", "- Портфолио"],
  ...
  { 
    ...
    internship: "no", 
    workFormat: "office",
    conditions: ["- Официальное оформление", "- Стабильная зарплата", "- Корпоративный транспорт"],
    responsibilities: ["- Ведение бухгалтерского учета", "- Подготовка налоговой отчетности", "- Работа с 1С"],
  ...
  { 
    ...
    fullDescription: "Разработка и реализация маркетинговых кампаний, анализ рынка.", 
    city: "Грозный", 
    salaryMin: 90000, 
    salaryMax: null, 
    experience: "3-6", 
    ...
    internship: "no", 
    workFormat: "office",
    conditions: ["- Официальное оформление", "- Возможность карьерного роста", "- Корпоративное обучение"],
    responsibilities: ["- Разработка маркетинговых стратегий", "- Анализ рынка", "- Управление рекламными кампаниями"],
    requirements: ["- Опыт в digital-маркетинге от 3 лет", "- Знание Google Analytics", "- Аналитическое мышление"],
    keySkills: ["Digital-маркетинг", "Google Analytics", "Аналитика", "Креативность"],
    createdBy: null
  },
  { 
    title: "Официант", 
    ...
    responsibilities: ["- Обслуживание гостей", "- Прием заказов", "- Поддержание чистоты зала"],
  ...
  { 
    ...
    internship: "no", 
    workFormat: "office",
    conditions: ["- Полный социальный пакет", "- Корпоративное обучение", "- Современное оборудование"],
    responsibilities: ["- Настройка серверов", "- Обслуживание сетей", "- Обеспечение безопасности"],
    requirements: ["- Опыт работы с Linux/Windows от 3 лет", "- Знание сетевых протоколов", "- Ответственность"],
  ...
  { 
    ...
    fullDescription: "Подбор персонала, проведение собеседований, адаптация сотрудников.", 
    city: "Грозный", 
    salaryMin: 75000, 
    salaryMax: null, 
    experience: "1-3", 
    ...
    internship: "no", 
    workFormat: "office",
    conditions: ["- Официальное оформление", "- Корпоративные мероприятия", "- Возможность роста"],
    responsibilities: ["- Подбор персонала", "- Проведение собеседований", "- Адаптация новых сотрудников"],
    requirements: ["- Опыт в HR от 2 лет", "- Знание трудового законодательства", "- Коммуникабельность"],
  ...
  { 
    ...
    internship: "no", 
    workFormat: "office",
    conditions: ["- Гибкий график", "- Компенсация транспорта", "- Бонусы за заказы"],
    responsibilities: ["- Доставка заказов", "- Работа с приложением", "- Взаимодействие с клиентами"],
    requirements: ["- Личный транспорт", "- Ответственность", "- Без опыта"],
    keySkills: ["Ответственность", "Водительские навыки", "Клиентоориентированность"],
    createdBy: null
  },
  { 
    title: "Копирайтер", 
    ...
    internship: "no", 
    workFormat: "remote",
    conditions: ["- Удаленная работа", "- Гибкий график", "- Творческая свобода"],
    responsibilities: ["- Написание текстов", "- Редактирование контента", "- Работа с SEO"],
    requirements: ["- Опыт написания текстов от 1 года", "- Грамотность", "- Знание SEO"],
  ...
  { 
    ...
    fullDescription: "Приготовление блюд, соблюдение рецептур, поддержание чистоты.", 
    city: "Грозный", 
    salaryMin: 55000, 
    salaryMax: 75000, 
    experience: "1-3", 
    ...
    internship: "no", 
    workFormat: "office",
    conditions: ["- Бесплатное питание", "- Форма от компании", "- Стабильный график"],
    responsibilities: ["- Приготовление блюд", "- Соблюдение санитарных норм", "- Работа в команде"],
    requirements: ["- Опыт работы поваром от 1 года", "- Знание рецептур", "- Ответственность"],
...
window.onload = function() {
  ...
  map = L.map('map', { center: [43.3178, 45.6949], zoom: 12, zoomControl: true });
  ...
  document.getElementById('job-list').addEventListener('click', handleJobCardClick);
  document.getElementById('responses-list').addEventListener('click', handleJobCardClick);
...
function initSkillsAutocomplete() {
  ...
  function updateSuggestions(query) {
    ...
    if (query) {
      const filteredSkills = availableSkills.filter(skill => 
        skill.toLowerCase().includes(query.toLowerCase()) && !selectedSkills.includes(skill)
      );
  ...
  document.addEventListener('click', (e) => {
    if (!skillsInput.contains(e.target) && !suggestionsList.contains(e.target)) {
      suggestionsList.classList.remove('visible');
    }
  });
...
function initAddressAutocomplete() {
  ...
  async function fetchAddressSuggestions(query) {
    ...
    try {
      const response = await fetch(`https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(query + ', Грозный')}&limit=5&addressdetails=1`);
  ...
  addressInput.addEventListener('keydown', (e) => {
    ...
    } else if (e.key === 'Enter' && focusedSuggestionIndex >= 0 && suggestions[focusedSuggestionIndex]) {
      e.preventDefault();
...
function openMapSelectModal() {
  ...
  mapSelect = L.map('map-select', { zoomControl: true }).setView([43.3178, 45.6949], 12);
  L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    attribution: '© <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>',
    maxZoom: 19
  }).addTo(mapSelect);
  ...
  mapSelect.on('click', async function(e) {
    ...
    try {
      ...
      L.marker([lat, lng]).addTo(mapSelect).bindPopup(displayAddress).openPopup();
...
function handleJobCardClick(e) {
  ...
  if (!card || e.target.classList.contains('favorite') || e.target.closest('.favorite') || 
      e.target.classList.contains('respond-btn') || e.target.classList.contains('track-btn') || 
...
function showSection(section) {
  ...
  document.querySelectorAll('.main-section, .auth-section, .responses-section').forEach(s => s.classList.remove('active'));
  document.querySelector(`#${section}-section`).classList.add('active');
  document.querySelectorAll('.main-header, .auth-header').forEach(h => h.style.display = 'none');
  document.getElementById('main-header').style.display = section === 'auth' ? 'none' : 'flex';
  document.getElementById('auth-header').style.display = section === 'auth' ? 'flex' : 'none';
  if (section === 'main' && map) {
    setTimeout(() => map.invalidateSize(), 300);
  }
  document.querySelector('#header-nav .fa-heart').classList.toggle('active', isShowingFavorites);
  document.querySelector('#header-nav .fa-check').classList.toggle('active', isShowingResponses);
}
...
function updateHeader() {
  ...
  if (currentUser.email) {
    ...
    if (currentUser.role === 'employer') {
      ...
      nav.insertBefore(createBtn, document.getElementById('city-select'));
    } else {
      const createBtn = document.createElement('button');
      createBtn.className = 'create-btn';
...
async function createJob(e) {
  ...
  const salaryMax = document.getElementById('job-salary-max').value ? parseInt(document.getElementById('job-salary-max').value) : null;
  ...
  const fullDescription = document.getElementById('job-description').value.trim();
  const conditions = document.getElementById('job-conditions').value.trim().split('\n').map(c => `- ${c.trim()}`).filter(c => c !== '- ');
  const responsibilities = document.getElementById('job-responsibilities').value.trim().split('\n').map(r => `- ${r.trim()}`).filter(r => r !== '- ');
  ...
  if (!title || !company || !salaryMin || !fullDescription || !address || keySkills.length === 0) {
    showNotification('Заполните все обязательные поля, включая ключевые навыки');
    return;
  }
...
function handleLogin() {
  ...
  if (users[email] && users[email].password === password) {
    localStorage.setItem('currentUser', JSON.stringify({ email, name: users[email].name, role: selectedRole }));
    showSection('main');
    updateHeader();
...
function handleRegister() {
  ...
  localStorage.setItem('currentUser', JSON.stringify({ email, name, role: selectedRole }));
  showSection('main');
  updateHeader();
...
function updateJobList(filteredJobs = jobs) {
  ...
  filteredJobs.forEach(job => {
    ...
    const experienceTag = job.experience === 'noExperience' ? 
      `<span class="tag">${getExperienceText(job.experience)}</span>` : 
      `<span class="tag">Опыт: ${getExperienceText(job.experience)}</span>`;
    card.innerHTML = `
      <span class="favorite" onclick="toggleFavorite(this, '${job.title}')"><i class="fas fa-heart"></i></span>
      <h3>${job.title}</h3>
      ...
      <button class="respond-btn${respondedJobs.includes(job.title) ? ' responded' : ''}" onclick="respondToJob('${job.title}')">Откликнуться</button>
      <button class="track-btn" onclick="trackOnMap(${job.lat}, ${job.lng}, '${job.title}')">Показать на карте</button>
    `;
...
function updateResponsesList() {
  ...
  const respondedJobsList = jobs.filter(job => respondedJobs.includes(job.title));
  respondedJobsList.forEach(job => {
    ...
    card.innerHTML = `
      ...
      <div class="company">${job.company}</div>
      <div class="address">${job.city}, ${job.description}</div>
      <button class="remove-btn" onclick="removeResponse('${job.title}')">Удалить</button>
    `;
...
function removeResponse(title) {
  ...
  updateResponsesList();
  document.querySelectorAll(`.respond-btn[onclick="respondToJob('${title}')"]`).forEach(btn => {
...
function updateMap(filteredJobs) {
  ...
  filteredJobs.forEach(job => {
    ...
    `;
    const marker = L.marker([job.lat, job.lng]).addTo(map).bindPopup(popupContent);
...
function searchJobs() {
  ...
  const internship = document.getElementById('internship-filter').checked ? 'yes' : '';
  ...
  const filteredJobs = jobs.filter(job => {
    const matchesQuery = query === '' || job.title.toLowerCase().includes(query) || job.company.toLowerCase().includes(query) || job.fullDescription.toLowerCase().includes(query);
    const matchesCity = city === 'Вся Россия' || job.city === city;
    const matchesExperience = experience === '' || job.experience === experience;
    const matchesEmployment = employment === '' || job.employment === employment;
    const matchesSchedule = schedule === '' || job.schedule === schedule;
    const matchesHours = hours === '' || job.hours === hours;
    const matchesInternship = internship === '' || job.internship === internship;
    const matchesWorkFormat = workFormat === '' || job.workFormat === workFormat;
    const matchesSalary = !salary || parseInt(job.salaryMin) >= parseInt(salary);
    return matchesQuery && matchesCity && matchesExperience && matchesEmployment && matchesSchedule && matchesHours && matchesInternship && matchesWorkFormat && matchesSalary;
  });
...
function openJobModal(title, company, salary, description, experience, employment, schedule, hours, internship, workFormat, conditions, responsibilities, requirements, keySkills) {
  ...
  const conditionsArray = Array.isArray(conditions) ? conditions : conditions.split('|');
  const conditionsElement = document.getElementById('modal-conditions');
  conditionsElement.innerHTML = `<h4>Условия</h4><ul>${conditionsArray.map(item => `<li>${item}</li>`).join('')}</ul>`;
  
  const responsibilitiesArray = Array.isArray(responsibilities) ? responsibilities : responsibilities.split('|');
  const responsibilitiesElement = document.getElementById('modal-responsibilities');
  responsibilitiesElement.innerHTML = `<h4>Обязанности</h4><ul>${responsibilitiesArray.map(item => `<li>${item}</li>`).join('')}</ul>`;
  ...
  requirementsElement.innerHTML = `<h4>Требования</h4><ul>${requirementsArray.map(item => `<li>${item}</li>`).join('')}</ul>`;
  
  const keySkillsArray = Array.isArray(keySkills) ? keySkills : keySkills.split('|');
  const keySkillsElement = document.getElementById('modal-key-skills');
  keySkillsElement.innerHTML = `<h4>Ключевые навыки</h4><div class="key-skills">${keySkillsArray.map(skill => `<span class="tag">${skill}</span>`).join('')}</div>`;
  
  document.getElementById('modal-experience').textContent = getExperienceText(experience);
  document.getElementById('modal-employment').textContent = getEmploymentText(employment);
  document.getElementById('modal-schedule').textContent = getScheduleText(schedule);
  document.getElementById('modal-hours').textContent = hours + ' ч';
  document.getElementById('modal-internship').textContent = internship === 'yes' ? 'Да' : 'Нет';
  document.getElementById('modal-work-format').textContent = getWorkFormatText(workFormat);
  
  const modal = document.getElementById('job-modal');
  const modalContent = modal.querySelector('.modal-content');
  modal.style.display = 'flex';
  setTimeout(() => modalContent.classList.add('active'), 10);
  document.getElementById('modal-respond-btn').onclick = () => respondToJob(title);
  document.getElementById('modal-respond-btn').classList.toggle('responded', respondedJobs.includes(title));
...
function respondToJob(title) {
  const marker = markers.find(m => m.jobTitle === title);
  const wasPopupOpen = marker && marker.getPopup() && marker.getPopup().isOpen();
